...
def calculate():
    ...
    y = int(enter_3.get())
    total = a*i*y/100
    label_4 = Label(root, text= total, background="Light Green", font=("ds-digital", 20))
    label_4.grid(row=5, column=1, padx=20, pady=10, columnspan=10)
    enter_3.delete(0, END)
    enter_1.delete(0, END)
    enter_2.delete(0, END)


label_1 = Label(root, text="Enter principal amount  ", foreground="Black", background="light green", font=("ds-digital", 10))
...
label_2 = Label(root, text="Enter rate of interest  ", background="Light Green", font=("ds-digital", 10))
...
label_3 = Label(root, text="Enter time period  ", background="Light Green", font=("ds-digital", 10))
